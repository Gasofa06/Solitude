...
function Suggest_Topics(_prefix, _max_suggestions) {
    ...
    (function () {
        let all_input_suggestions =
            window.search_suggestions.querySelectorAll('.suggestion input');
    ...
    let html_suggestions = _suggestions
        .map(_topic => {
            ...
            let svg = contains_topic
                ...
                : '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" fill="var(--soft-gray)" ><path d="M14 1a1 1 0 0 1 1 1v12a1 1 0 0 1-1 1H2a1 1 0 0 1-1-1V2a1 1 0 0 1 1-1h12zM2 0a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V2a2 2 0 0 0-2-2H2z" style="&#10;    /* fill: aliceblue; */&#10;"/></svg>';
...
function Suggest_Titles(prefix, max_suggestions) {
    ...
    window.search_suggestions.querySelectorAll('input').forEach(input => {
